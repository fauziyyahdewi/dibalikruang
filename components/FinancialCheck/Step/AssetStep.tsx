...
const recommendedAssets = [{ name: "Rumah" }, { name: "Kendaraan" }];

function AssetStep({ form }: { form: UseFormReturn<FormValues> }) {
  const { control } = form;
  ...
  return (
    <>
      ...
      <div className="bg-amber-50 rounded-lg p-4 mb-8">
        {fields.length > 0 && (
          <h3 className="text-lg font-medium mb-4">Punya aset lainnya?</h3>
        )}
          ...
          <div className="mt-4 p-4 bg-white rounded-lg border border-amber-200">
            ...
            <div className="flex gap-2">
              <Input
                ...
                className="flex-1"
                placeholder="Contoh: Saham, Tanah, dll."
              />
              <Button
                type="button"
